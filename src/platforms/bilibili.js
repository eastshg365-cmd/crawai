...
async function collectVideos() {
    ...
    try { await apiPost('/ai/func/BILI_Video_Collect', {}); } catch (e) { toast(e.message || '权限验证失败', 'error'); return; }
    ...
    try { await apiPost('/ai/chrome_video/modify_add', { platform: 'bilibili', data: result }); } catch { }
